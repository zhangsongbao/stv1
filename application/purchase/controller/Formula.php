...
class Formula extends HnzlController{
    /**
     * 无需登录的方法,同时也就不需要鉴权了
     * @var array
     */
    ...
    public function _initialize(){
        parent::_initialize();
         //载入model
        $this->model=model('app\purchase\model\Formula');
        //载入验证器
        $this->validate=new \app\purchase\validate\Formula();
    }
    /**
     * @param $where
     * @param $model
